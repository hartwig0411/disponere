...
*Anforderungsdokument — Version 6.7*
*Stand: 21. August 2026 (Bild-Anzeige in der Eintragskarte verkleinert — Ideen-Eingang E-01)*
...
- **Anzeige als kleines Vorschau-Quadrat** in der Eintragskarte — eine kompakte, quadratische
  ...
  ersetzt die frühere „Thumbnail, dabei in der Journal-Ansicht volle Breite"-Darstellung.
  Reversible Details für die Umsetzung: Kantenlänge ~72 px, `BoxFit.cover` zentriert. Reine
  Anzeige-Änderung, kein Schema-Eingriff.)*
...
| Bild-Anzeige als kleines Vorschau-Quadrat (Journal + Tag-Ansicht, Vollbild beim Antippen) | 🟢 Enhancement | ⏳ Versio (v6.7, E-01) — reine Anzeige, kein Schema |
