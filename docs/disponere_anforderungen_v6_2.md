...
*Anforderungsdokument — Version 6.2*
*Stand: 13. August 2026 (Nachtrag: datierter Eintrag)*
...
(Kopf-Thema).** Eine semantische Gabelung bleibt für den Session-Start offen, vor dem
Coden zu klären (siehe Offene Punkte): surft der datierte Eintrag **nur** am gewählten
Tag auf oder **auch** am Erstelltag?
...
| Datierter Eintrag (Inhalt/Bild surft an gewähltem Tag auf, kein Abhaken) | 🟡 Core | ⏳ Versio, nächste Session |
...
| Datierter Eintrag — Anzeige-Semantik | **Vor dem Coden der nächsten Session zu klären:** surft der datierte Eintrag **nur** am gewählten Anzeige-Day auf, oder **auch** am Erstelltag? (Rezept-Fall: heute mit Bild anlegen, Freitag sehen — soll es heute schon im Journal stehen oder still bis Freitag warten?) Reine Anzeige-Frage; Modell voraussichtlich nur ein optionales Anzeige-Day am Eintrag, kein Abhaken. |
