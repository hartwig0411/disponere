...
*Anforderungsdokument — Version 6.11*
*Stand: 28. August 2026 (drittes Brücken-Bein Termin → Eintrag — Architektur entschieden, noch nicht gebaut)*
...
| Brücke Termin → Eintrag (drittes Bein; Long-Press Terminkarte, Titel + Beschreibung, `display_day` = Termintag, Tag-Vererbung) | 🟡 Core | ⏳ Versio (28.08.2026 Architektur entschieden, noch nicht gebaut) |
