...
*Anforderungsdokument — Version 6.17*
*Stand: 24. September 2026 (E-06 entschieden — Text überall markier- und kopierbar, Weg 2: lange drücken markiert, Aktionsmenüs wandern hinter ⋮; Bau offen; E-04 und E-05 weiterhin offen)*
...
### Text markieren & kopieren ⏳ *(E-06, entschieden 24.09.2026, Bau offen)*
...
| Text überall markier- und kopierbar (lange drücken markiert; Aktionsmenüs hinter ⋮) | 🟡 Core | ⏳ entschieden 24.09.2026 (E-06) — Weg 2, kein Schema |
...
| Brücke Termin → Eintrag (drittes Bein; Long-Press Terminkarte, Titel + Beschreibung, `display_day` = Termintag, Tag-Vererbung) | 🟡 Core | ✅ Session 60 — gebaut; Schema v9 (`calendar_events.description` ergänzt, Sync liest sie mit) |
