...
*Anforderungsdokument — Version 6.15*
*Stand: 8. September 2026 (Tintenmodus als scrollbare Endlos-Rolle mit Autoscroll — Weg A gebaut, Session 63 Teil II; Kachelung der Auswertung bewusst später; E-04 OneCalendar-Share offen)*
...
- **Tag-Ausschluss (Feld „Nicht Auswerten") ⏳ *(E-02, entschieden 26.08.2026 — noch nicht gebaut)*:**
  Standardmäßig fließen **alle** Tags in die Auswertung. Ein Feld **„Nicht Auswerten"** nimmt die
  auszunehmenden Tags auf. Der Filter greift auf **Tag-Ebene**: ein Eintrag bleibt im Material,
  ...
  **vorbefüllt** („aus der Vorwoche gezogen") und beim Ändern zurückgeschrieben. Kein
  ...
  Settings-Mechanismus) ist eine **reversible** Coding-Detailentscheidung.
...
| Wochenauswertung: Tag-Ausschluss (Feld „Nicht Auswerten", globale Liste, Filter auf Tag-Ebene) | 🟢 Enhancement | ⏳ Versio (E-02, 26.08.2026 entschieden, noch nicht gebaut) |
