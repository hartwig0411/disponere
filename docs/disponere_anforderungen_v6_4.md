...
*Anforderungsdokument — Version 6.4*
*Stand: 17. August 2026 (Nachtrag: Brücke Eintrag ↔ Aufgabe — Architektur entschieden, Umsetzung folgt)*
...
- **Brücke zum Eintrag (v6.4, Architektur entschieden, Umsetzung folgt):** per Knopf aus
  ...
  Details im Änderungsblock „gegenüber Version 6.3".
...
| Brücke Eintrag ↔ Aufgabe (aus Eintrag Aufgabe / aus Aufgabe datierter Eintrag, Tag-Vererbung) | 🟡 Core | ⏳ Versio, hohe Prio — Architektur entschieden (v6.4), kein Schema-Umbau, Umsetzung folgt |
